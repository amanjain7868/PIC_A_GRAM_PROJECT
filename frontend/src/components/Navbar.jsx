  ...
  return (
    <div className="flex gap-2 md:gap-5 w-full mt-5 pb-7">
      ...
      <Link to={`user-profile/${user?._id}`} className="hidden md:block">
          ...
          <Link to="/create-pin" className="hover:bg-black hover:text-white bg-white text-black rounded-lg w-12  h-12 md:w-14 md:h-12 flex justify-center items-center">
            <IoMdAdd  />
          </Link>
